...
const features = [
  {
    ...
    description:
      "Encuentra cualquier carta al instante por nombre, texto, tipo o rareza. Filtros avanzados para coleccionistas exigentes.",
  },
  {
    icon: CameraIcon,
    title: "Escanea con tu cámara",
    description:
      "Apunta tu cámara a cualquier carta y la identificamos automáticamente. Añádela a tu colección con un solo toque.",
  },
  {
    icon: LanguageIcon,
    title: "Traducción instantánea",
    description:
      "Cada carta tiene su traducción al español. Entiende todos los efectos y habilidades sin barreras de idioma.",
  },
  {
    icon: ClipboardIcon,
    title: "Creador de mazos",
    description:
      "Diseña, guarda y comparte tus mazos. Analiza estadísticas y optimiza tu estrategia con herramientas visuales.",
  },
  {
    icon: BookOpenIcon,
    title: "Guías y tutoriales",
    description:
      "Aprende a jugar con nuestras guías detalladas. Desde reglas básicas hasta estrategias avanzadas para torneos.",
  },
  {
    icon: ArchiveBoxIcon,
    title: "Gestión de Inventario",
    description:
      "Controla tu colección de cartas con nuestra herramienta de gestión de inventario. Añade, edita y elimina cartas de tu colección con facilidad.",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl leading-relaxed text-[var(--muted)]">
            Herramientas pensadas por y para coleccionistas de Lorcana de habla
            hispana.
          </p>
        </div>
        ...
        <div className="mt-20 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group relative rounded-2xl border border-[var(--stroke)]/30 bg-[var(--panel)]/40 p-8 backdrop-blur-sm transition-all duration-300 hover:border-[var(--accent)]/40 hover:bg-[var(--panel)]/60"
            >
        ...
        <div className="mt-32 grid items-center gap-16 lg:grid-cols-2">
          <div className="order-2">
            ...
            <h3
              className="mt-4 text-2xl font-bold text-[var(--ink)] sm:text-3xl lg:text-4xl"
              style={{ fontFamily: "var(--font-title)" }}
            >
              Explora cada carta con detalle
            </h3>
            <p className="mt-6 leading-relaxed text-[var(--muted)]">
              Accede a información completa de cada carta: estadísticas, rareza,
              edición, etc... Con imágenes en alta resolución y datos
            ...
            <ul className="mt-8 space-y-4">
              {[
                ...
                <li
                  key={item}
                  className="flex items-center gap-4 text-[var(--muted)]"
                >
