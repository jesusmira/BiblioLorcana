...
export default function EmptyState({
  ...
  return (
    <div className={`flex flex-col items-center gap-6 rounded-[24px] border border-[var(--stroke)] bg-[var(--surface-soft)]/50 p-16 text-center backdrop-blur-sm ${className}`}>
      {icon && (
